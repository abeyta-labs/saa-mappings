...
def update_jqwik_time_mapping():
    ...
    # Desired file:   ../../.advisor/mappings/jqwik-time.json
    ...
    target_path = os.path.join(mappings_dir, "jqwik-time.json")
    ...
    try:
        ...
        if source_path == generated_path:
            ...
            # clobbered that in the working tree with time-only content --
